...
> Updated after significant changes. Read at start of every session via `.github/copilot-instructions.md`.
...
- Full AI instruction system: `.github/copilot-instructions.md`, skills, prompts, file instructions
...
- `copilot-instructions.md` — Self-contained master instruction file (replaces `.claude/claude.md`)
- `skills/` — tdd, grill-me, write-a-prd, prd-to-issues, improve-codebase-architecture, frontend-design
- `prompts/` — code-review
- `instructions/` — server-routes, frontend-components, database, constants-guard, security
