...
export const BottomNav: React.FC<BottomNavProps> = ({
    ...
    const isCloset = location.pathname === '/closet';
    ...
    return (
        ...
        >
            <div className="flex items-center justify-around h-[60px]">
                ...
                <button
                    onClick={() => navigate('/')}
                    className="flex flex-col items-center justify-center gap-1 min-w-[64px] min-h-[56px] active:scale-95 transition-transform"
                >
                ...
                <button
                    ...
                    className="flex flex-col items-center justify-center gap-1 min-w-[64px] min-h-[56px] active:scale-95 transition-transform"
                >
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={isCloset ? '#d4b872' : '#666'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <span className="text-[10px] font-medium tracking-wide" style={{ color: isCloset ? '#d4b872' : '#666' }}>Closet</span>
                </button>
                ...
                <button
                    onClick={() => onCartClick?.()}
                    className="relative flex flex-col items-center justify-center gap-1 min-w-[64px] min-h-[56px] active:scale-95 transition-transform"
                >
