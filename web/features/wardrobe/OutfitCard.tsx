...
export const OutfitCard: React.FC<OutfitCardProps> = ({ outfit, onTryOn }) => {
  ...
  return (
    <div className="group relative flex flex-col gap-2 transition-all duration-300">
      ...
      <div className="relative aspect-[3/4] w-full rounded-[24px] overflow-hidden bg-elevated">
        ...
        <button className="absolute top-4 right-4 z-10 text-gold/80 hover:text-gold transition-colors drop-shadow-md">
        ...
        {onTryOn && (
          <div className="absolute bottom-3 inset-x-0 flex justify-center z-10">
            <button
              ...
              className="px-6 py-2 rounded-full text-[13px] font-semibold text-[#0a0a0a] bg-primary hover:bg-white active:scale-95 transition-transform shadow-lg shadow-black/20"
            >
              Try-on
            </button>
          </div>
